#include "Demo/ToolsSystemDemoGameModeBase.h"
...
AToolsSystemDemoGameModeBase::AToolsSystemDemoGameModeBase()
{
...
void AToolsSystemDemoGameModeBase::StartPlay()
{
	Super::StartPlay();
...
void AToolsSystemDemoGameModeBase::InitializeToolsSystem()
{
...
void AToolsSystemDemoGameModeBase::RegisterTools()
{
...
void AToolsSystemDemoGameModeBase::ShutdownToolsSystem()
{
	// TODO: implement this
	check(false);
}
